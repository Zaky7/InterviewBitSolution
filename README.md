...
|12| [Reverse Integer](https://www.interviewbit.com/problems/reverse-integer/)      | [Java](./src/BitManipulation/ReverseInteger.java)  | _O(number of digits)_         | _O(1)_          | Easy         | |
...
|5| [Longest Palindromic Substring](https://www.interviewbit.com/problems/longest-palindromic-substring/)      | [Java](./src/String/LongestPalindromeSubString.java)  | _O(n*n)_         | _O(1)_          | Medium         |  Bookmarked, 1 length is always palindrome |
...
|7| [Compare Version Numbers](https://www.interviewbit.com/problems/compare-version-numbers/)      | [Java](./src/String/CompareVersions.java)  | _O(n)_         | _O(n)_          | Medium         |  Bookmarked|
...
|3| [Nearest Smaller Element](https://www.interviewbit.com/problems/nearest-smaller-element/)      | [Java](./src/stacks/NearestSmaller.java)  | _O(n)_         | _O(n)_          | Easy         |   |
